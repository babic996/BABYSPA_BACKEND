...
public class DiscountController {
  ...
  @PostMapping("/save")
  public ResponseEntity<ApiResponse<Discount>> save(
      @RequestBody @Valid CreateDiscountDto createDiscountDto) {
  ...
  public ResponseEntity<ApiResponse<Discount>> update(
      @RequestBody @Valid UpdateDiscountDto updateDiscountDto) {
