    ...
    if (statusRepository.count() == 0) {
      ...
      statusRepository.save(
          new Status(
              ...
              statusTypeRepository.findByStatusTypeCode("reservation")));
      statusRepository.save(
          new Status("Plaćen", "paid", statusTypeRepository.findByStatusTypeCode("arrangement")));
      statusRepository.save(
          new Status(
              "Nije plaćen", "not_paid", statusTypeRepository.findByStatusTypeCode("arrangement")));
      statusRepository.save(
          new Status(
              "Kreiran", "created", statusTypeRepository.findByStatusTypeCode("arrangement")));
    }
