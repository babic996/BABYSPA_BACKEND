...
public class ArrangementSnapshotService {
    ...
    @Autowired
    ArrangementSnapshotRepository arrangementSnapshotRepository;
    ...
    public ArrangementSnapshot save(Arrangement arrangement) {
        ...
        arrangementSnapshot.setDiscountInfo(Objects.nonNull(arrangement.getDiscount()) ? arrangement.getDiscount().toString() : "");
        arrangementSnapshot.setPaymentTypeInfo(Objects.nonNull(arrangement.getPaymentType()) ? arrangement.getPaymentType().toString() : "");
        arrangementSnapshot.setGiftCardInfo(Objects.nonNull(arrangement.getGiftCard()) ? arrangement.getGiftCard().toString() : "");
