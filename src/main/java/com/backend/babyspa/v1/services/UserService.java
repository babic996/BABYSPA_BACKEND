...
public class UserService {
  ...
  public User findById(int userId) {
    return userRepository
        .findById(userId)
        .orElseThrow(
            () -> new NotFoundException("Nije pronađen korisnik čiji je ID: " + userId + "!"));
  }
        ...
        .orElseThrow(
            () ->
                new NotFoundException(
                    "Nije pronađen korisnik čiji je username: " + username + "!"));
  }
  ...
  @Transactional
  public User addNewTenantUser(
      AddNewTenantUserDto addNewTenantUserDto, Authentication authentication) {
    boolean hasPermission =
        authentication.getAuthorities().stream()
